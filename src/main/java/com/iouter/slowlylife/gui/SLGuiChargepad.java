...
public class SLGuiChargepad extends GuiContainer {
    private final SLContainerChargepad container;
    private final String level;
    private final String name;
    private static final ResourceLocation BACKGROUND =
            new ResourceLocation(Tags.MODID + ":textures/gui/gui_storageunit.png");

    public SLGuiChargepad(SLContainerChargepad container, String name) {
        super(container);
